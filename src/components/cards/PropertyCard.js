              ...
              <Card.Body className="d-flex flex-column justify-content-between card-body">
                ...
                <div>
                  ...
                  <Row className="Area-details">
                    <Col className="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xsm-12  Area-details-1">
                      <Row className="justify-content-center align-items-center  ">
                        <Col className="text-center Room-area-icon-1 ">
                    ...
                    <Col className="d-flex justify-content-end col-3 Area-details-2">
                      <Button
                        variant="success"
            ...
            <div key={property.id}>
              <Card className="property-card-mb reduced-width">
                <Card.Body className="d-flex flex-column justify-content-between card-body">
                  ...
                  <Row className="Area-details">
                    <Col className="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xsm-12  ">
                      <Row className="justify-content-center align-items-center">
                        <Col className="text-center ">
                          <LuRuler className="Room-area-icon" />
